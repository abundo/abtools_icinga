...
def main():
    ...
    if host:
        ...
        subject = "%s, Service '%s' is in state '%s' !" % (args.NOTIFICATIONTYPE, args.SERVICEDISPLAYNAME, args.SERVICESTATE)
    ...
    if host:
        ...
        msg.append("%s, Service '%s' is in state <strong>'%s'</strong><br>" % (args.NOTIFICATIONTYPE, args.SERVICEDISPLAYNAME, args.SERVICESTATE))
    msg.append("<br>")
        ...
        try:
            ...
            if state_down:
                ...
                for state in state_down:
                    ...
                    msg.append("%s%s</td>" % (TD, state.pe_comments))
    ...
    if 1:
        ...
        try:
            ...
            if state_down:
                ...
                msg.append("</tr>")
                for state in state_down:
                    # utils.pretty_print("state", state)
                    msg.append(TR)
    ...
    email = Email()
    if 1:
        if args.HOSTDISPLAYNAME != "test-anders.net.piteenergi.se":
